class GameCanvas extends Canvas {
    canvasSizeFactor: number
    readonly cellSize: number
    readonly canvasWidth: number
    readonly canvasHeight: number
    readonly visualFieldOffsetLeft: number
    readonly visualFieldOffsetTop: number
    readonly playableFieldOffsetLeft: number
    readonly playableFieldOffsetTop: number
    readonly playableFieldWidth: number
    readonly playableFieldHeight: number
    readonly thickLine1Offset: number
    readonly thickLine2Offset: number
